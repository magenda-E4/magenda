        ...
        <div class = "col-md-6 col-sm-12">
            ...
            <form action="?controller=user&action=signUp" method="POST">
                ...
                <p>
                    ...
                    <input type="text" name="phonenumber" value="<?php if (isset($_POST["phonenumber"])){ echo $_POST["phonenumber"];}?>"/>
                ...
                <p>
                    ...
                    <input type="date" name="datebirth" value="<?php if (isset($_POST["datebirth"])){ echo $_POST["datebirth"];}?>"/>
